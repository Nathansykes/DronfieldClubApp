    ...
    <div class="container">
        ...
        <main>
            <div class="mainContent">
                <!--content goes here-->
                <h1 class="siteTitle">Dronfield Swimming Club | Level 7 Test </h1>
                ...
                <table class= 'table'> 
                    ...
                    <!-- ROW 1-->
                    <tr class='tableRow'>
                        <td>Swim 25 metres backstroke (refer to the ASA expected stroke standards sheet)</td>
                    ...
                    <!-- ROW 2-->
                    <tr class='tableRow'>
                        <td>Swim 25 metres front crawl (refer to the ASA expected stroke standards sheet)</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 3-->
                    <tr class='tableRow'>
                        <td>Swim 25 metres breaststroke (refer to the ASA expected stroke standards sheet)</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 4-->
                    <tr class='tableRow'>
                        <td>Swim 25 metres butterfly (refer to the ASA expected stroke standards sheet)</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 5-->
                    <tr class='tableRow'>
                        <td>Perform a movement sequence of 1 minute duration, in a group of three or more, incorporating a number of skills</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 7-->
                    <tr class='tableRow'>
                        <td>Swim 50 metres continously using one stroke</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 8-->
                    <tr class='tableRow'>
                        <td>Swim 100 metres using a minimum of three different strokes</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 9-->
                    <tr class='tableRow'>
                        <td>Tread water using an eggbeater action for 30 seconds</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 10-->
                    <tr class='tableRow'>
                        <td>Complete an obstacle course (using a minimum of four objects) with feet off the pool floor throughout</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
