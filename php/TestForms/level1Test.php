...
<body>
    <div class="container">
        ...
        <main>
            <div class="mainContent">
                <!--content goes here-->
                <h1 class="siteTitle">Dronfield Swimming Club | Level 1 Test </h1>
                ...
                <table class= 'table'> 
                    ...
                    <!-- ROW 5-->
                    <tr class='tableRow'>
                        <td>Scoop the water and splash face</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 6-->
                    <tr class='tableRow'>
                        <td>Be at ease with water showered from overhead</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 7-->
                    <tr class='tableRow'>
                        <td>Move into a stretched floating position - aids, equipment or support is allowed</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 8-->
                    <tr class='tableRow'>
                        <td>Regain a standing position from their back with support</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 9-->
                    <tr class='tableRow'>
                        <td>Regain a standing position from their front with support</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 10-->
                    <tr class='tableRow'>
                        <td>Push and glide in a horizontal position to or from a wall</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 11-->
                    <tr class='tableRow'>
                        <td>Take part in a teacher led partner orientated game</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 12-->
                    <tr class='tableRow'>
                        <td>Demonstrate an understanding of pool rules</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
    ...
    <script src="../../scripts/main.js"></script> <!--Ensure links to js are ../../ (or ... in UNIX)-->
</body>
</html>