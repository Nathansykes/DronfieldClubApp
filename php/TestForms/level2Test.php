    ...
    <div class="container">
        ...
        <main>
            <div class="mainContent">
                <!--content goes here-->
                <h1 class="siteTitle">Dronfield Swimming Club | Level 2 Test </h1>
                ...
                <table class= 'table'> 
                    ...
                    <!-- ROW 1-->
                    <tr class='tableRow'>
                        <td>Jump in from poolside safely</td>
                    ...
                    <!-- ROW 2-->
                    <tr class='tableRow'>
                        <td>Blow bubbles a minimum of three times rhythmically with nose and mouth submerged</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 3-->
                    <tr class='tableRow'>
                        <td>Regain a standing position from their back without support</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 4-->
                    <tr class='tableRow'>
                        <td>Regain a standing position from their from without support</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 5-->
                    <tr class='tableRow'>
                        <td>Push from wall and glide on their back</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 6-->
                    <tr class='tableRow'>
                        <td>Push from wall and glide on their front</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 7-->
                    <tr class='tableRow'>
                        <td>Travel on back 5 metres - aids or equipment mau be used</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 8-->
                    <tr class='tableRow'>
                        <td>Travel on the front 5 metres-aids or equipment may be used</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 9-->
                    <tr class='tableRow'>
                        <td>Perform a rotation front to back and gain an upright position</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
                    ...
                    <!-- ROW 10-->
                    <tr class='tableRow'>
                        <td>Perform a rotation from the back to front and gain an upright position</td>
                        <td class='radioButton'>
                            <label for="pass">Pass</label>
